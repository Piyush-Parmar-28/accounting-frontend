...
class AddClient extends React.Component<any, PropsFromRedux> {
  ...
  constructor(props: any) {
    const editUser = (props as any)?.editUser;
    super(props);
                    ...
                    <div className="col-span-3 lg:col-span-2">
                      ...
                      <div className="mt-1 flex rounded-md shadow-sm">
                        <input
                          ...
                          disabled
                          id="company_website"
                          className="focus:ring-indigo-500 bg-gray-100 opacity-70 cursor-not-allowed focus:border-indigo-500 flex-1 block w-full rounded-md sm:text-sm border-gray-300"
                          placeholder="Email"
                        />
                      </div>
                    </div>
