...
function EntriesList(props: PropsFromRedux) {
  ...
  let inititalState = {
    ...
    entries: [
      {
        "accountId": "63a57fa2242513b07d7df291",
        "accountName": "Capital",
        "amount": 122,
        "_id": "63abca0d8f714f9bf8dffd86"
      }
    ],
    totalRecords: 1,
    displayEntryDetails: [
      {
        "_id": "63abca0d8f714f9bf8dffd85",
        ...
        "entries": [
          ...
          },
          {
            ...
            "accountName": "Capital",
            "amount": 122,
            "_id": "63abca0d8f714f9bf8dffd87"
          },
          {
            "accountId": "63a57fa2242513b07d7df291",
            "accountName": "Capital",
            "amount": 213,
            "_id": "63abca0d8f714f9bf8dffd88"
          }
        ],
        "receivedAccountId": "639db17ca45ee3ff0b74200c",
        "receivedAccountName": "Cash",
        "receivedAmount": 457,
        "narration": "narration.",
        "organisationId": "639db07227fe851da7fbab6f",
        "year": "2022-23",
        "accountsToShow": "Capital, Capital, Capital",
        "amountToShow": 457,
        "version": 1,
        "isDeleted": false,
        "createdAt": "2022-12-28T04:46:05.985Z",
        "updatedAt": "2022-12-28T04:46:05.985Z",
        "__v": 0
      }
    ],
    selectedEntries: [],
  ...
  //     )
  //       .then((response: any) => {
  //         downloadFile(response, `Receipt Entries - ${year}.xlsx`);
  //         (props as any).onNotify(
  //           "Download",
    ...
    <Dashboard>
      <div className="gsts">
        ...
        <div className="px-4 sm:px-6 md:px-8 grid grid-cols-12 gap-4 mt-6">
          <div className="w-fit col-span-4 flex gap-4">
            <button
              type="button"
          ...
          state.totalRecords > 0 || state.searchText.length > 0 ? (
              ...
              <div className="mt-4 flex flex-col">
                ...
                >
                  <div className="min-w-full py-2 align-middle md:px-6 lg:px-8">
                    <div className="shadow-sm ring-1 ring-black ring-opacity-5 grid grid-cols-12">
                      <table
                        className="min-w-full border-separate border shadow-sm col-span-6"
                      ...
                      >
                        ...
                        {state.totalRecords === 0 ? (
                          ...
                          <tbody className="bg-white">
                            <tr>
                              <td className="font-bold w-1/12 whitespace-nowrap py-4 pl-4 pr-3 text-sm text-black-900 sm:pl-6">Capital</td>
                              <td className="w-1/12 whitespace-nowrap py-4 pl-4 pr-3 text-sm text-black-900 sm:pl-6">xxx</td>
                              <td className="w-1/12 whitespace-nowrap py-4 pl-4 pr-3 text-sm text-black-900 sm:pl-6">xxx</td>
                            </tr>
                            <tr>
                              <td className="font-bold w-1/12 whitespace-nowrap py-4 pl-4 pr-3 text-sm text-black-900 sm:pl-6">Provisions</td>
                              <td className="w-1/12 whitespace-nowrap py-4 pl-4 pr-3 text-sm text-black-900 sm:pl-6"></td>
                              <td className="w-1/12 whitespace-nowrap py-4 pl-4 pr-3 text-sm text-black-900 sm:pl-6">xxx</td>
                            </tr>
                            <tr>
                              <td className="font-bold w-1/12 whitespace-nowrap py-4 pl-4 pr-3 text-sm text-black-900 sm:pl-6">Reserves</td>
                              <td className="w-1/12 whitespace-nowrap py-4 pl-4 pr-3 text-sm text-black-900 sm:pl-6">xxx</td>
                              <td className="w-1/12 whitespace-nowrap py-4 pl-4 pr-3 text-sm text-black-900 sm:pl-6">xxx</td>
                            </tr>
                            <tr>
                              <td className="font-bold w-1/12 whitespace-nowrap py-4 pl-4 pr-3 text-sm text-black-900 sm:pl-6">Loans</td>
                              <td className="w-1/12 whitespace-nowrap py-4 pl-4 pr-3 text-sm text-black-900 sm:pl-6"></td>
                              <td className="w-1/12 whitespace-nowrap py-4 pl-4 pr-3 text-sm text-black-900 sm:pl-6">xxx</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td className="font-bold w-1/12 whitespace-nowrap py-4 pl-4 pr-3 text-sm text-black-900 sm:pl-6">Current Liabilities</td>
                              <td className="w-1/12 whitespace-nowrap py-4 pl-4 pr-3 text-sm text-black-900 sm:pl-6"></td>
                              <td className="w-1/12 whitespace-nowrap py-4 pl-4 pr-3 text-sm text-black-900 sm:pl-6">xxx</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td className="font-bold w-1/12 whitespace-nowrap py-4 pl-4 pr-3 text-sm text-black-900 sm:pl-6">Miscellaneous Liabilities
                            ...
                            <tr>
                              <td className="font-bold w-1/12 whitespace-nowrap py-4 pl-4 pr-3 text-sm text-black-900 sm:pl-6">
                                Profit or Loss A/c
                              </td>
                              <td className="w-1/12 whitespace-nowrap py-4 pl-4 pr-3 text-sm text-black-900 sm:pl-6"></td>
                              <td className="w-1/12 whitespace-nowrap py-4 pl-4 pr-3 text-sm text-black-900 sm:pl-6">xxx</td>
                        ...
                        <thead className="bg-gray-50">
                          <tr>
                            <th
                              style={{ zIndex: 6 }}
                              scope="col"
                              className="sticky top-0 border-b border-gray-300 bg-gray-50 px-4 py-3 text-left text-xs font-bold text-gray-900 tracking-wider sm:pl-6 align-middle"
                            >
                            ...
                            <th
                              style={{ zIndex: 6 }}
                              scope="col"
                              className="sticky top-0 border-b border-gray-300 bg-gray-50 px-4 py-3 text-left text-xs font-bold text-gray-900 uppercase tracking-wider sm:pl-6 align-middle"
                            >
                      ...
                      >
                        ...
                        {state.totalRecords === 0 ? (
                          ...
                          <tbody className="bg-white">
                            <tr>
                              <td className="font-bold w-1/12 whitespace-nowrap py-4 pl-4 pr-3 text-sm text-black-900 sm:pl-6">Fixed Asset
                            ...
                            <tr>
                              <td className="font-bold w-1/12 whitespace-nowrap py-4 pl-4 pr-3 text-sm text-black-900 sm:pl-6">Investments
                              </td>
                              <td className="w-1/12 whitespace-nowrap py-4 pl-4 pr-3 text-sm text-black-900 sm:pl-6"></td>
                              <td className="w-1/12 whitespace-nowrap py-4 pl-4 pr-3 text-sm text-black-900 sm:pl-6">xxx</td>
                            </tr>
                            <tr>
                              <td className="font-bold w-1/12 whitespace-nowrap py-4 pl-4 pr-3 text-sm text-black-900 sm:pl-6">Deposits - Assets
                              </td>
                              <td className="w-1/12 whitespace-nowrap py-4 pl-4 pr-3 text-sm text-black-900 sm:pl-6">xxx</td>
                              <td className="w-1/12 whitespace-nowrap py-4 pl-4 pr-3 text-sm text-black-900 sm:pl-6">xxx</td>
                            </tr>
                            <tr>
                              <td className="font-bold w-1/12 whitespace-nowrap py-4 pl-4 pr-3 text-sm text-black-900 sm:pl-6">Current Assets</td>
                              <td className="w-1/12 whitespace-nowrap py-4 pl-4 pr-3 text-sm text-black-900 sm:pl-6"></td>
                              <td className="w-1/12 whitespace-nowrap py-4 pl-4 pr-3 text-sm text-black-900 sm:pl-6">xxx</td>
                            </tr>
                            <tr>
            ...
            <div className="text-center my-10 border-2 border-gray-300 border-dashed p-16 md:mx-40 sm:mx-0 rounded-lg">
              ...
              <h3 className="mt-2 text-sm font-medium text-gray-900">
                No Receipt Entry Present
              </h3>
              <p className="mt-1 text-sm text-gray-500">
                Get started by adding a new Receipt Entry.
              </p>
              <div className="mt-6">
                <button
                  type="button"
